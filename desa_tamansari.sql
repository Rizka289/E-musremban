...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2020 at 05:58 PM
...
INSERT INTO `tbl_bidang` (`id_bidang`, `kode_rek`, `Nama_rek`) VALUES
(21, '324', 'edfds');
...
(1, 'super admin', 'superAdmin@gmail.com', 'defaultP.jpg', '$2y$10$VXbZyE8av9sa4j5dY0vk4u5ex4H9j5y3LjB/o09wsgCnIa5lhm1rK', 1, 1, 0, '2020-05-10 13:14:21'),
(2, 'admin', 'admin@gmail.com', 'defaultP.jpg', '$2y$10$9lHgS1CwCHKo1atb.efw7e/wcQEzrET5QfaH7e2oesMBQ11YRZSJS', 2, 1, 0, '2020-05-10 13:14:12');
...
--
ALTER TABLE `tbl_usulan`
  ADD CONSTRAINT `fk_usulan_sub` FOREIGN KEY (`id_sub_bidang`) REFERENCES `tbl_sub_bidang` (`Id_sub_bidang`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usulan_tahun` FOREIGN KEY (`id_tahun`) REFERENCES `tbl_tahun` (`id_tahun`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
